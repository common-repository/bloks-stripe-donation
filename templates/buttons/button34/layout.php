 ...
 * */
?>
<a href="javascript:void(0);" class="blope-btn-button34 blope-donation-btn blope-btn-animate {flexible}" {attributes}>
...
<style type="text/css">
    ...
    .blope-btn-button34 span.blope-btn-content{
    ...
    .blope-btn-button34 .fa{font-size:24px; color:#fff; position:absolute;     left: 16px;    top: 15px; z-index:1;}
</style>
