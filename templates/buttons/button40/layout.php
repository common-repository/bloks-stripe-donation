 ...
 * */
?>
<a href="javascript:void(0);" class="blope-btn-button40 blope-donation-btn blope-btn-animate {flexible}" {attributes}>
...
<style type="text/css">
    .blope-btn-button40,
    .blope-btn-button40:hover
    {
        background: #85b14f!important ;
        display: inline-block;
        position: relative;
        text-align: left;
        box-shadow: 0px  4px  #719743 !important;
    ...
    .blope-btn-button40 span{  font-family: 'Roboto Slab', serif;    font-weight: bold;     font-size: 27px;     }
    .blope-btn-button40 .fa{
        margin-left: 18px;font-size:19px;
        background: #5e8b27; width:40px; height:40px; border-radius:50%; line-height: 40px;
        position: absolute;right:20px; top:10px;    text-align: center;
    }
    .blope-btn-button40 span.blope-btn-desc{
