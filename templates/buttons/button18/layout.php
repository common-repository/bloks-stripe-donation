 ...
 * */
?>
<a href="javascript:void(0);" class="blope-btn-button18 blope-donation-btn blope-btn-animate {flexible}" {attributes}>
...
<style type="text/css">
    .blope-btn-button18,
    .blope-btn-button18:hover
    {
        background: #9e57b7 ;
        display: inline-block;
        position: relative;
        text-align: center;
        box-shadow: 0px 2px  #712e89 !important;
        border-radius: 5px;
        margin: 0px;
        overflow: hidden;
    ...
    .blope-btn-button18 span{  font-family: 'Roboto Slab', serif;    font-weight: bold;     font-size: 22px;        font-weight: bold;}
    .blope-btn-button18 .fa{margin-left: 20px;font-size: 22px;   font-weight: bold; position: absolute;top:14px; right:16px; z-index: 2; }
    .blope-btn-button18  .blope-btn-right{ background:url({template_url}/right.png) left  repeat-x !important ;width:54px; height:54px;
