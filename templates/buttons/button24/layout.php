 ...
 * */
?>
<a href="javascript:void(0);" class="blope-btn-button24 blope-donation-btn blope-btn-animate {flexible}" {attributes}>
    <span class="blope-btn-button24-left"><strong class="blope-currency">{currency_symbol}<strong class="blope-btn-amount">{amount}</strong></strong></span>
    <span class="blope-btn-content">
        <span class="blope-btn-title">{title}</span>
        <span class="blope-btn-desc">{desc}</span>
    </span>
    <span class="blope-btn-button24-right"><i class="fa fa-gift"></i></span>
</a>
<link href="https://fonts.googleapis.com/css?family=Ubuntu:400,700" rel="stylesheet">
<style type="text/css">
    .blope-btn-button24-left{width:74px; height:62px; background:url({template_url}/images/left.png) left  no-repeat  ; display: block; float: left;}
    .blope-btn-button24-right{width:77px; height:62px; background:url({template_url}/images/right.png) left  no-repeat  ; display: block; float: left;}

    .blope-btn-button24,
    .blope-btn-button24:hover
    ...
    .blope-btn-button24 .fa{font-size:20px; color:#fff; z-index:1;position:absolute;     right: 20px;    top: 18px;}
    .blope-btn-button24 .blope-btn-content {
    ...
    .blope-btn-button24 .blope-btn-title{
        color:#ed911e;
        font-family: 'Ubuntu', sans-serif !important;
    ...
    .blope-btn-button24 .blope-btn-desc{
        color:#ed911e;
        display: block !important;
        font-family: 'Ubuntu', sans-serif !important;
        font-size:10px;
    ...
    .blope-btn-button24 .blope-currency{
    ...
    .blope-btn-button24 .blope-btn-amount{
