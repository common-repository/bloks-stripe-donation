 ...
 * */
?>
<a href="javascript:void(0);" class="blope-btn-button15 blope-donation-btn blope-btn-animate {flexible}" {attributes}>
...
<style type="text/css">
    .blope-btn-button15,
    .blope-btn-button15:hover
    {
        background: #546b74 ;
        display: inline-block;
        position: relative;
        text-align: center;
        box-shadow: 0px 2px  #47606a !important;
        border-radius: 5px;
        margin: 0px;
        overflow: hidden;
    ...
    .blope-btn-button15 span{  font-family: 'Roboto Slab', serif;    font-weight: bold;     font-size: 22px;        font-weight: bold;}
    .blope-btn-button15 .fa{margin-left: 20px;font-size: 22px;   font-weight: bold; }
    .blope-btn-button15  .blope-btn-right{ background:url({template_url}/right.png) left  repeat-x !important ;width:54px; height:54px;
