 ...
 * */
?>
<a href="javascript:void(0);" class="blope-btn-button41 blope-donation-btn blope-btn-animate {flexible}" {attributes}>
...
<style type="text/css">
    .blope-btn-button41,
    .blope-btn-button41:hover
    {
        background: #fbaf35!important ;
        display: inline-block;
        position: relative;
        text-align: left;
        box-shadow: 0px  4px  #d6952d !important;
    ...
    .blope-btn-button41 span{  font-family: 'Roboto Slab', serif;    font-weight: bold;     font-size: 27px;     }
    .blope-btn-button41 .fa{
        margin-left: 18px;font-size:19px;
        background: #da8e15; width:40px; height:40px; border-radius:50%; line-height: 40px;
        position: absolute;right:20px; top:10px;    text-align: center;
    }
    .blope-btn-button41 span.blope-btn-desc{
